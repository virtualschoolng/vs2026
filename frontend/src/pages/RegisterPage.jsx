...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const endpoint = `http://localhost:5000/auth/register${isTrial ? '?trial=true' : ''}`;
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-center text-secondary font-headline mb-6">Create Your Account</h2>
